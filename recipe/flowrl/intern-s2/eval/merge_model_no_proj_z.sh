...
LOCAL_DIR="${LOCAL_DIR:-/mnt/shared-storage-user/llmit/user/xuekaizhu/verl_FlowRL/work_dirs/FlowRL_Scaling/FlowRL-Qwen2.5-7B-DAPO-Math-prompt-modified-reward-no-log-z-1130/20251129_234317/ckpts/global_step_75/actor}"
# Where to save the merged HuggingFace model
TARGET_DIR="${TARGET_DIR:-/mnt/shared-storage-user/llmit/user/xuekaizhu/verl_FlowRL/work_dirs/FlowRL_Scaling/FlowRL-Qwen2.5-7B-DAPO-Math-prompt-modified-reward-no-log-z-1130/20251129_234317/huggingface/global_step_75}"
# ============================================
