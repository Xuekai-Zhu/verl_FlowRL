...
# FlowRL objective: no_log_z (ablation study without partition function)
export FLOWRL_OBJECTIVE=no_log_z
...
exp_name='FlowRL-Qwen2.5-7B-DAPO-Math-prompt-modified-reward-no-log-z-1130'
